...
if(isset($_POST['nama'])){
    ...
    $query =mysqli_query($conn, "INSERT INTO transaksi (nama,hp,harga,alamat) values('$nama','$hp','$harga','$alamat')");
    if($query) {
            ...
            <form class="mb-5" method="post">
              <div class="row">
                ...
                <div class="col-md-6 form-group mb-3">
                  ...
                  <input type="text" class="form-control" name="hp" id="hp"  placeholder="Masukan Nomor HP">
                </div>
              </div>
